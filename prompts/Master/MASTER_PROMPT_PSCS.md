...
| CNH motorista | Alerta por validade (2 meses / 1 mês). **Renovar CNH** ou digitalizar nova CNH **sobrescreve** número/validade; ao salvar com validade em dia o alerta antigo some (equivalente à limpeza na renovação de documentos). |
