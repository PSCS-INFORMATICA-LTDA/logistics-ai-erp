...
| Marca / logos | **Sistema (menu + login):** PSCS Systems 3D — “Systems” no meio→direita com contorno branco. **Header (cliente):** só emblema GRX sem fundo (`/grx-company-mark.png`; texto preto). **Docs:** logo GRX em placa. |
