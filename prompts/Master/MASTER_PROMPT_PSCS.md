...
| Marca / logos | **Sistema (menu + login):** Logistics AI Platform (`/pscs-logo-mark.png`) — azul claro + vermelho claro. **Header (cliente):** texto **GRX Transportes e Logística** com liquid glass. **Docs:** logo GRX em placa. |
