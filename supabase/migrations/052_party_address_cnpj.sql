-- 052: Endereço completo + IE + situação CNPJ em clients, suppliers e companies
-- Consulta CNPJ (BrasilAPI) preenche e grava no banco.
...
-- trade_name já pode existir em companies (schema atual); ADD IF NOT EXISTS é seguro.
