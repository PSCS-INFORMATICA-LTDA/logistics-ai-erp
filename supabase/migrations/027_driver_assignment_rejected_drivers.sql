-- Histórico persistente de motoristas que recusaram designação (sobrevive a nova designação).
...
-- Nova designação: reseta resposta atual, mas preserva driver_assignment_rejected_driver_ids.
...
-- Backfill OS001 (recusa antes da migration 026/027): se driver_assignment_response='rejected'
-- e driver_assignment_rejected_driver_ids vazio, preencha manualmente com o UUID do MOT001:
-- UPDATE public.service_orders
-- SET
