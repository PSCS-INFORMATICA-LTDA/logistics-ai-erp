-- GRX Management — Cobrança mensal (assinatura cartão via Asaas)
-- Migration: 037_company_billing.sql
...
COMMENT ON TABLE public.company_billing_settings IS
  'Mensalidade PSCS: valores teste/produção e status da assinatura Asaas. Não armazena número/CVV do cartão.';
