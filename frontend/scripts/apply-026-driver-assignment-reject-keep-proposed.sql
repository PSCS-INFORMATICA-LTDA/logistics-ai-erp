-- Cole no SQL Editor do Supabase após 024/025.
-- Mantém proposed_driver_id quando o motorista recusa (para exibir quem recusou na listagem).
...
-- Se a OS já tinha recusa ANTES desta migration (proposed_driver_id ficou NULL), ajuste manualmente, ex.:
-- UPDATE public.service_orders SET proposed_driver_id = '<uuid-do-motorista>'
-- WHERE code = 'OS001' AND driver_assignment_response = 'rejected' AND proposed_driver_id IS NULL;
